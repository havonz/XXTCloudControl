if sys.xtversion():compare_version("1.3.8-20260119000000") < 0 then
	error('Este script requiere XXT 1.3.8-20260119000000 o una versión posterior')
	return
end
...
local enable_label = 'Activar control en la nube'
local address_label = 'Dirección del servidor'
local dlg = dialog()
