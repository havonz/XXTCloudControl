if sys.xtversion():compare_version("1.3.8-20260119000000") < 0 then
	error('Для этого скрипта требуется XXT 1.3.8-20260119000000 или более поздняя версия')
	return
end
...
local enable_label = 'Включить облачное управление'
local address_label = 'Адрес сервера'
local dlg = dialog()
